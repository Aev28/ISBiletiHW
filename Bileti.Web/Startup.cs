...
namespace Bileti.Web
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddTransient<ITicketService, Service.Impl.TicketService>();
            services.AddTransient<IShoppingCartService, Service.Impl.ShoppingCartService>();
            services.AddTransient<IOrderService, Service.Impl.OrderService>();
